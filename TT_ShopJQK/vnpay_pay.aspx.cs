...
namespace TT_ShopJQK
{
    public partial class vnpay_pay : System.Web.UI.Page
    {
        ...
        protected void btnPay_Click(object sender, EventArgs e)
        {
            ...
            order.OrderID = 20; // Giả lập mã giao dịch hệ thống merchant gửi sang VNPAY
            order.ShippingCost = 100000; // Giả lập số tiền thanh toán hệ thống merchant gửi sang VNPAY 100,000 VND
            order.Status = 1; //0: Trạng thái thanh toán "chờ thanh toán" hoặc "Pending" khởi tạo giao dịch chưa có IPN
